  ...
  <div class="app-container">
    ...
    >
      <div class="operate-container">
        ...
        <div>
          <el-button style="float: right" type="primary" @click="getList()"> 查询搜索 </el-button>
...
<script lang="ts">
  ...
  import { defineComponent, shallowReactive, reactive, ref } from 'vue'
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const getList = (
        ...
        console.log('表格数据', powerfulTabledata)
      }
      getList()
      ...
      const handleResetSearch = () => {
        Object.keys(powerfulTabledata.listQuery).forEach((item: any, index: number) => {
      ...
      const refresh = (from: any) => {
        ...
        // 添加修改
        if (from.id) {
          let index = powerfulTabledata.list.map((item: any) => item.id).indexOf(from.id)
