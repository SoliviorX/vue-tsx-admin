  ...
  >
    ...
    >
      ...
      <el-form-item label="类型" prop="types">
        <el-select v-model="currentForm.types" placeholder="请选择" style="width: 100%">
          <el-option
      ...
      <el-form-item label="内容" prop="text">
        <el-input type="textarea" v-model="currentForm.text" rows="7"></el-input>
      </el-form-item>
      <el-form-item label="评分" prop="rate">
        <div class="a">
          <el-rate v-model="currentForm.rate" :colors="[themeColor, themeColor, themeColor]">
          </el-rate>
        </div>
      </el-form-item>
