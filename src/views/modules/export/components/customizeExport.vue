  ...
  <div>
    <el-form :inline="true" :model="formInline1" size="mini">
      <el-form-item label="副标题：">
        <el-input v-model="formInline1.subtitle" placeholder="副标题"></el-input>
      </el-form-item>
      <el-form-item label="对其方式：">
        <el-select v-model="formInline1.align" placeholder="对其方式" style="width: 100px">
      ...
      <el-form-item>
        <el-button-group>
          <!-- TODO 导入功能 -->
          <el-button type="primary" :icon="Top" size="mini" @click="export1">导出</el-button>
        </el-button-group>
      </el-form-item>
    </el-form>
    <p></p>
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="date" :align="formInline1.align" label="Date" width="180" />
      <el-table-column prop="name" :align="formInline1.align" label="Name" width="180" />
      <el-table-column prop="address" :align="formInline1.align" label="Address" />
    </el-table>
    <p></p>
    <div class="tipBox">
      复杂表格导出
      <div style="font-size: 13px; color: var(--el-color-info)"> （多级表头，合计） </div>
    </div>
    <el-form :inline="true" :model="formInline2" size="mini">
      <el-form-item label="对其方式：">
        <el-select v-model="formInline2.align" placeholder="对其方式" style="width: 100px">
          <el-option label="靠左" value="left"></el-option>
          <el-option label="居中" value="center"></el-option>
          <el-option label="靠右" value="right"></el-option>
        </el-select>
      ...
      <template v-if="formInline2.showSummary">
        ...
        <el-form-item label="保留小数位：">
          <el-input style="width: 100px" v-model="formInline2.sumToFixed" placeholder="请输入">
      ...
      <el-form-item>
        <el-button-group>
          <el-button type="primary" :icon="Top" size="mini" @click="export2">导出</el-button>
        </el-button-group>
      </el-form-item>
    </el-form>
    <p></p>
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="date" :align="formInline2.align" label="Date" width="150" />
      <el-table-column label="Delivery Info">
        <el-table-column prop="name" :align="formInline2.align" label="Name" width="120" />
        <el-table-column label="Address Info">
          <el-table-column prop="state" :align="formInline2.align" label="State" width="120" />
          <el-table-column prop="city" :align="formInline2.align" label="City" width="120" />
          <el-table-column prop="address" :align="formInline2.align" label="Address" />
          <el-table-column prop="money" :align="formInline2.align" label="Money(RMB)" width="120" />
          <el-table-column prop="zip" :align="formInline2.align" label="Zip" width="120" />
        </el-table-column>
      </el-table-column>
    </el-table>
    <p></p>
    ...
    <el-button-group>
      <el-button type="primary" :icon="Top" size="mini" @click="export3">多表导出</el-button>
    </el-button-group>
    <p></p>
    <div class="tipBox warning">
      <span>
    ...
    <powerful-table :list="list" :header="config" :isPagination="false"> </powerful-table>
  </div>
</template>

<script lang="ts">
  import { header, lists } from './indexData'
  import { ref, reactive, defineComponent, inject, nextTick, toRefs, onMounted } from 'vue'
  import { exportExcelSheet } from '@/utils/export'
  import { tableData1, tableData2 } from './indexData'
  import { QuestionFilled, Top } from '@element-plus/icons'
      ...
      const getSummaries = (param: any) => {
        ...
        columns.forEach((column: any, index: number) => {
          ...
          var substr = state.formInline2.showUnit
            ? column.label.substring(column.label.indexOf('(') + 1, column.label.indexOf(')'))
            : ''
          ...
          if (!values.every((value: any) => isNaN(value))) {
            ...
            sums[index] =
              Number(sums[index]).toFixed(state.formInline2.sumToFixed || 2) + ' ' + substr
          } else {
